  ...
  return (
    <>
      <form className="mt-5 mb-5 dark:text-nord0 space-y-7">
        <button className="btn hover:opacity-80 bg-nord11  inline-flex  justify-start items-center">
          <Google className="mr-3" /> Signup with Google
        </button>
        <button className="btn hover:opacity-80 bg-nord0  inline-flex items-center fill-current">
